...
//     {
//         case 'specifyLFR':
//             path = localStorage.PROJECT + '/specifyLFR.v';
//             break;
//         case 'specifyUCF':
//             path = localStorage.PROJECT + '/specifyUCF.json';
//             break;
//         case 'designMINT':
//             path = localStorage.PROJECT + '/designMINT.uf';
//             break;
//         case 'designINI':
//             path = localStorage.PROJECT + '/designINI.txt';
//             break;
//         case 'buildJSON':
