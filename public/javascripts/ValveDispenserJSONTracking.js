...
function setNumberOfPumps_JSON() {
    ...
    for (var i = 1; i <= localStorage.pumps; i++) {
        ...
        var singleStage = {id: i, HW_shield: (Math.floor(i/12) + 1), HW_pin: j, Open_State: initialize_valve_conversion.uL_max, Closed_State: 0, Current_State: 'opened', deviceIndex: deviceCount, uL_Conversion_Table: (initialize_valve_conversion.uL_table), uL_Precision: (initialize_valve_conversion.uL_precision), Cluster: []};
